function init() {
    ...
    async function fetchData(lat, lon) {
        try {
            ...
            document.getElementById("aqi").innerText = aData.current.us_aqi;
            document.getElementById("desc").innerText = aData.current.us_aqi < 50 ? "Không khí: Tốt" : "Không khí: Trung bình";
    ...
    // 3. Hiệu ứng khối nảy 2 tầng ngẫu nhiên
